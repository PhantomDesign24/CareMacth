...
export const registerPatient = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    ...
    const {
      ...
      diagnoses,
      infections,
      roomType, roomTypeEtc,
      longTermCareGrade,
      hasSurgery,
      treatments, treatmentsEtc,
      paralysisStatus,
      hygieneStatus, hygieneStatusEtc,
      mealStatus, mealStatusEtc,
      toiletStatus, toiletStatusEtc,
      exerciseStatus, exerciseStatusEtc,
      hasDelirium, hasBedsore, needsSuction, hasStoma,
      hospitalizationReason, hospitalizationReasonEtc,
    ...
    try {
      patient = await prisma.patient.create({
        ...
        roomTypeEtc: roomTypeEtc || null,
        longTermCareGrade: longTermCareGrade || null,
        hasSurgery: typeof hasSurgery === 'boolean' ? hasSurgery : null,
        treatments: Array.isArray(treatments) ? treatments : [],
        treatmentsEtc: treatmentsEtc || null,
        paralysisStatus: paralysisStatus || null,
        hygieneStatus: hygieneStatus || null,
        hygieneStatusEtc: hygieneStatusEtc || null,
        mealStatus: mealStatus || null,
        mealStatusEtc: mealStatusEtc || null,
        toiletStatus: toiletStatus || null,
        toiletStatusEtc: toiletStatusEtc || null,
        exerciseStatus: exerciseStatus || null,
        exerciseStatusEtc: exerciseStatusEtc || null,
        hasDelirium: typeof hasDelirium === 'boolean' ? hasDelirium : null,
        hasBedsore: typeof hasBedsore === 'boolean' ? hasBedsore : null,
        needsSuction: typeof needsSuction === 'boolean' ? needsSuction : null,
        hasStoma: typeof hasStoma === 'boolean' ? hasStoma : null,
        hospitalizationReason: hospitalizationReason || null,
...
export const updatePatient = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    ...
    const {
      ...
      hasDelirium, hasBedsore, needsSuction, hasStoma,
      hospitalizationReason, hospitalizationReasonEtc,
      covidTestRequirement, vaccineCheckRequirement,
    } = req.body;
    ...
    const updated = await prisma.patient.update({
      ...
      data: {
        ...
        // 신규 필드
        ...(diagnoses !== undefined && { diagnoses: Array.isArray(diagnoses) ? diagnoses : [] }),
        ...(infections !== undefined && { infections: Array.isArray(infections) ? infections : [] }),
        ...(roomType !== undefined && { roomType: roomType || null }),
        ...(roomTypeEtc !== undefined && { roomTypeEtc: roomTypeEtc || null }),
        ...(longTermCareGrade !== undefined && { longTermCareGrade: longTermCareGrade || null }),
        ...(hasSurgery !== undefined && { hasSurgery: typeof hasSurgery === 'boolean' ? hasSurgery : null }),
        ...(treatments !== undefined && { treatments: Array.isArray(treatments) ? treatments : [] }),
        ...(treatmentsEtc !== undefined && { treatmentsEtc: treatmentsEtc || null }),
        ...(paralysisStatus !== undefined && { paralysisStatus: paralysisStatus || null }),
        ...(hygieneStatus !== undefined && { hygieneStatus: hygieneStatus || null }),
        ...(hygieneStatusEtc !== undefined && { hygieneStatusEtc: hygieneStatusEtc || null }),
        ...(mealStatus !== undefined && { mealStatus: mealStatus || null }),
        ...(mealStatusEtc !== undefined && { mealStatusEtc: mealStatusEtc || null }),
        ...(toiletStatus !== undefined && { toiletStatus: toiletStatus || null }),
        ...(toiletStatusEtc !== undefined && { toiletStatusEtc: toiletStatusEtc || null }),
        ...(exerciseStatus !== undefined && { exerciseStatus: exerciseStatus || null }),
        ...(exerciseStatusEtc !== undefined && { exerciseStatusEtc: exerciseStatusEtc || null }),
        ...(hasDelirium !== undefined && { hasDelirium: typeof hasDelirium === 'boolean' ? hasDelirium : null }),
        ...(hasBedsore !== undefined && { hasBedsore: typeof hasBedsore === 'boolean' ? hasBedsore : null }),
        ...(needsSuction !== undefined && { needsSuction: typeof needsSuction === 'boolean' ? needsSuction : null }),
        ...(hasStoma !== undefined && { hasStoma: typeof hasStoma === 'boolean' ? hasStoma : null }),
        ...(hospitalizationReason !== undefined && { hospitalizationReason: hospitalizationReason || null }),
        ...(hospitalizationReasonEtc !== undefined && { hospitalizationReasonEtc: hospitalizationReasonEtc || null }),
        ...(covidTestRequirement !== undefined && { covidTestRequirement: covidTestRequirement || null }),
        ...(vaccineCheckRequirement !== undefined && { vaccineCheckRequirement: vaccineCheckRequirement || null }),
      },
    });
