  ...
  return (
    <div className="bg-white">
        ...
        <div className="relative w-full h-[280px] sm:h-[400px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center px-4">
            <div className="max-w-3xl text-center text-white">
              <h2 className="text-lg sm:text-2xl font-bold mb-3 sm:mb-4 leading-snug">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 text-center">
        <div className="inline-flex flex-col items-center gap-1 bg-primary-50 rounded-2xl px-10 py-6">
          <span className="text-xs text-gray-500">고객센터</span>
          <a href={`tel:${SITE.phone}`} className="text-2xl sm:text-3xl font-bold text-primary-600">{SITE.phone}</a>
