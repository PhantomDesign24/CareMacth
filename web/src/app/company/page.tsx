...
const SECTIONS = [
  ...
  },
  {
    ...
    body: "병원간병(질병, 교통사고, 산재사고, 기타 일반 상해·질병), 재택간병, 가족간병, 생활돌봄간병, 중증환자 집중 간병서비스까지 전문적이고 훈련된 간병인들이 표준화된 매뉴얼을 바탕으로 여러분과 함께 할 수 있도록 케어매치 간병 서비스는 노력하고 있습니다.",
...
const VALUES = [
  ...
  { name: "Passion", img: "/img/company/e_cInfo_img06.jpg", desc: "내게 주어진 모든 일에 열렬한 애정을 가지고 온 마음을 다하여 임하고 그 결과에 만족한다." },
];
